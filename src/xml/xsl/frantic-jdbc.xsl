...
<title>FusionReactor JDBC LogReport</title>
<style>
{
  margin: 0;
  padding: 0;
...
<body>
	<div class="post">
		<div id="header" style="padding-left:16">
		  <h1 class="title">FusionReactor JDBC LogReport</h1>
		</div>
	</div>


  <div id="page">
   <table id="calendar" style="border:1px ridge gray" width="75%" cellpadding="2" cellspacing="0">
        <tr style="background-color:#eaeaea">
           <xsl:call-template name="print-column-headers" />
         </tr>
           <xsl:apply-templates />
        </table>
        </div>
...
<xsl:template name="details" match="/frantic/entry">
 ...
 <xsl:template name="print-column-headers" match="/frantic/entry[1]">
	<xsl:for-each select="child::*">
